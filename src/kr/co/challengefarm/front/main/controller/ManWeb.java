...
@Controller("kr.co.challengefarm.front.main.controller.ManWeb")
public class ManWeb extends Common  {

	
	/** Logger */
	private static Logger logger = LoggerFactory.getLogger(ManWeb.class);
