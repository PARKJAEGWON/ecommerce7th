...
@Controller("kr.co.challengefarm.front.main.controller.WomenWeb")
public class WomenWeb extends Common  {

	
	/** Logger */
	private static Logger logger = LoggerFactory.getLogger(WomenWeb.class);
